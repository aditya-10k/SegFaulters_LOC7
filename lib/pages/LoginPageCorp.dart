...
class LoginpageCorp extends StatefulWidget {
  const LoginpageCorp({Key? key}) : super(key: key);

  @override
  _LoginContainerState createState() => _LoginContainerState();
}

class _LoginContainerState extends State<LoginpageCorp> {
  ...
  void dispose() {
    ...
    final url = Uri.parse('http://localhost:5000/api/auth/loginCorporate');
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        InkWell(
                          onTap: (){
                            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> Signupcorp()));
                          },
                          child: Text(
                            'New? Sign In',
                            style: TextStyle(
