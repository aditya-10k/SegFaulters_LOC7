...
class Signupcorp extends StatefulWidget {
  const Signupcorp({Key? key}) : super(key: key);

  @override
  _SignupcorpState createState() => _SignupcorpState();
}

class _SignupcorpState extends State<Signupcorp> {
